...
image = cv2.imread('image/IMG_20220824_111044.jpg') # iron_chic.jpg rooster.jpg
(h, w) = image.shape[:2]
...
for i in range(0, detections.shape[2]):
	...
	if confidence > conf:
		...
		cv2.putText(image, text, (startX+30, y-10), 0, 2, color, 5)
# save output image
cv2.imwrite('result/gokturk yemir miray car DL.jpg', image, [cv2.IMWRITE_JPEG_QUALITY, 70])
